...
public interface ValidationConstants {
	...
	String WRONG_MIN_PERSON_ID_VALUE_MESSAGE = "Person ID must be greater or equal " + MIN_PERSON_ID_VALUE;
	String WRONG_MAX_PERSON_ID_VALUE_MESSAGE = "Person ID must be less or equal " + MAX_PERSON_ID_VALUE;
	...
	String WRONG_DATE_FORMAT_MESSAGE = "Wrong date format, must be YYYY-MM-dd";
	String MISSING_PERSON_EMAIL_MESSAGE = "Missing email address";
	String WRONG_EMAIL_FORMAT_MESSAGE = "Wrong email format";
}
