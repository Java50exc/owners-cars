...
import static telran.cars.api.ValidationConstants.WRONG_MAX_PERSON_ID_VALUE_MESSAGE;
import static telran.cars.api.ValidationConstants.WRONG_MIN_PERSON_ID_VALUE_MESSAGE;
...
public class CarsController {
	...
	PersonDto deletePerson(
			@PathVariable(name = "id") @NotNull(message = MISSING_PERSON_ID_MESSAGE) @Min(value = MIN_PERSON_ID_VALUE, message = WRONG_MIN_PERSON_ID_VALUE_MESSAGE) @Max(value = MAX_PERSON_ID_VALUE, message = WRONG_MAX_PERSON_ID_VALUE_MESSAGE) long id) {
	...
	List<CarDto> getOwnerCars(
			@PathVariable @NotNull(message = MISSING_PERSON_ID_MESSAGE) @Min(value = MIN_PERSON_ID_VALUE, message = WRONG_MIN_PERSON_ID_VALUE_MESSAGE) @Max(value = MAX_PERSON_ID_VALUE, message = WRONG_MAX_PERSON_ID_VALUE_MESSAGE) long id) {
